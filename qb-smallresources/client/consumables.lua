...
RegisterNetEvent('consumables:client:DrinkAlcohol', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"bira"})
    QBCore.Functions.Progressbar("snort_coke", Lang:t('consumables.liqour_progress'), math.random(3000, 6000), false, true, {
        ...
        TriggerServerEvent('hud:server:RelieveStress', math.random(2, 4))
        alcoholCount = alcoholCount + Config.ConsumablesAlcohol[itemName]

        if alcoholCount >= 66 and  alcoholCount <= 99 then
            LightDrunk()
        elseif alcoholCount >= 100 then
            HeavyDrunk()
            alcoholCount = 0
        end
...
RegisterNetEvent('consumables:client:Coke1', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed1", "Kokain içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        TriggerServerEvent("consumables:server:Coke1")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-coke-bad-ql"], "remove", 1)
...
RegisterNetEvent('consumables:client:Coke2', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed2", "Kokain içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("consumables:server:Coke2")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-coke-med-ql"], "remove", 1)
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
        CokeBaggyEffect()
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:Coke3', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed3", "Kokain içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("consumables:server:Coke3")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-coke-max-ql"], "remove", 1)
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
        CokeBaggyEffect()
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:Weed1', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed1", "Ot içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("consumables:server:Opium1")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-opium-bad-ql"], "remove", 1)
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
        CokeBaggyEffect()
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:Weed2', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed2", "Ot içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("consumables:server:Opium2")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-opium-med-ql"], "remove", 1)
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
        CokeBaggyEffect()
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:Weed3', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_weed3", "Ot içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
        ...
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
        TriggerServerEvent("consumables:server:Opium3")
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["package-opium-max-ql"], "remove", 1)
        TriggerEvent("evidence:client:SetStatus", "widepupils", 300)
        CokeBaggyEffect()
    end, function() -- Cancel
        StopAnimTask(ped, "switch@trevor@trev_smoking_meth", "trev_smoking_meth_loop", 1.0)
...
RegisterNetEvent('consumables:client:Opium1', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_opium", "Afyon içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:Opium2', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_opium2", "Afyon içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:Opium3', function()
    local ped = PlayerPedId()
    QBCore.Functions.Progressbar("snort_opium3", "Afyon içiliyor.", math.random(7000, 10000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('consumables:client:UseArmor', function()
    if GetPedArmour(PlayerPedId()) >= 100 then QBCore.Functions.Notify("Zaten yeterince zırhın var.", 'error') return end
    QBCore.Functions.Progressbar("use_armor", "Zırh giyiliyor...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
